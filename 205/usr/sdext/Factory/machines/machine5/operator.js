...
//*********************comment when Q/a Not in system******************
	...
	/*	var ddt1 = document.getElementById("json_date").value;
		...
		if (output_product == "Nil") {
			...
			document.getElementById('start1').value = "/usr/sdext/Factory/machines/machine5/index2.shtm?" + data1 + "#" + ctp;
		}*/
//  *********************END*************************
...
//*********************comment when Q/a Not in system******************
	/*		var ddt1 = document.getElementById("json_date").value;
		...
		if (output_product == "Nil") {
			...
			document.getElementById('start2').value = "/usr/sdext/Factory/machines/machine5/index2.shtm?" + data1 + "#" + ctp;
		}*/
//  *********************END*************************
