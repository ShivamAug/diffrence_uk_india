...
slow1@=slow1@+(10/60) d_slow1@=d_slow1@+(10/60)
Else If slow1>wd1_speed_lsl@ And speed1@>zero_sp1@   Then
mx_sp1@=mx_sp1@+(10/60) speed1_add@=speed1_add@+speed1@ speed1_avg_count@=speed1_avg_count@+1
Endif
Endif
...
slow2@=slow2@+(10/60) d_slow2@=d_slow2@+(10/60)
Else If slow2>wd2_speed_lsl@ And speed2@>zero_sp1@   Then
mx_sp2@=mx_sp2@+(10/60) speed2_add@=speed2_add@+speed2@ speed2_avg_count@=speed2_avg_count@+1
Endif
Endif
...
slow3@=slow3@+(10/60)  d_slow3@=d_slow3@+(10/60)
Else If slow3>wd3_speed_lsl@ And speed3@>zero_sp3@   Then
mx_sp3@=mx_sp3@+(10/60) speed3_add@=speed3_add@+speed3@ speed3_avg_count@=speed3_avg_count@+1
Endif
Endif
...
slow4@=slow4@+(10/60)  d_slow4@=d_slow4@+(10/60)
Else If slow4>wd4_speed_lsl@ And speed4@>zero_sp4@   Then 
mx_sp4@=mx_sp4@+(10/60) speed4_add@=speed4_add@+speed4@ speed4_avg_count@=speed4_avg_count@+1
Endif
Endif
...
slow5@=slow5@+(10/60)  d_slow5@=d_slow5@+(10/60)
Else If slow5>wd5_speed_lsl@ And speed5@>zero_sp5@   Then
mx_sp5@=mx_sp5@+(10/60) speed5_add@=speed5_add@+speed5@ speed5_avg_count@=speed5_avg_count@+1
Endif
Endif
...
slow6@=slow6@+(10/60)  d_slow6@=d_slow6@+(10/60)
Else If slow6>wd6_speed_lsl@ And speed6@>zero_sp6@   Then
mx_sp6@=mx_sp6@+(10/60) speed6_add@=speed6_add@+speed6@ speed6_avg_count@=speed6_avg_count@+1
Endif
Endif
...
If slow8<=wd8_speed_lsl@ And speed8@>zero_sp8@   Then
 slow8@=slow8@+(10/60)  d_slow8@=d_slow8@+(10/60)
Else If slow8>wd8_speed_lsl@ And speed8@>zero_sp8@   Then
mx_sp8@=mx_sp8@+(10/60) speed8_add@=speed8_add@+speed8@ speed8_avg_count@=speed8_avg_count@+1
Endif
Endif
...
slow9@=slow9@+(10/60)  d_slow9@=d_slow9@+(10/60)
Else If slow9>wd9_speed_lsl@ And speed9@>zero_sp9@   Then
mx_sp9@=mx_sp9@+(10/60) speed9_add@=speed9_add@+speed9@ speed9_avg_count@=speed9_avg_count@+1
Endif
Endif
...
slow10@=slow10@+(10/60)  d_slow10@=d_slow10@+(10/60)
Else If slow10>wd10_speed_lsl@ And speed10@>zero_sp10@   Then
mx_sp10@=mx_sp10@+(10/60) speed10_add@=speed10_add@+speed10@ speed10_avg_count@=speed10_avg_count@+1
Endif
Endif
...
slow11@=slow11@+(10/60)  d_slow11@=d_slow11@+(10/60)
Else If slow11 > wd11_speed_lsl@ And speed11@>zero_sp11@   Then
mx_sp11@=mx_sp11@+(10/60) speed11_add@=speed11_add@+speed11@ speed11_avg_count@=speed11_avg_count@+1
Endif
Endif
...
slow12@=slow12@+(10/60) d_slow12@=(d_slow12@+(10/60))
Else If slow12>wd12_speed_lsl@ And speed12@>zero_sp12@   Then
mx_sp12@=mx_sp12@+(10/60) speed12_add@=speed12_add@+speed12@ speed12_avg_count@=speed12_avg_count@+1
Endif
Endif
...
If res_kg_on_off@=0 Then kg_h2@=kg_r2@ Endif kg_b2@=1 kg_r2@=0
...
If res_kg_on_off@=0 Then kg_h3@=kg_r3@ Endif kg_b3@=1 kg_r3@=0
...
If res_kg_on_off@=0 Then kg_h4@=kg_r4@ Endif kg_b4@=1 kg_r4@=0
...
If res_kg_on_off@=0 Then kg_h5@=kg_r5@ Endif kg_b5@=1 kg_r5@=0
...
If res_kg_on_off@=0 Then kg_h6@=kg_r6@ Endif kg_b6@=1 kg_r6@=0
...
If res_kg_on_off@=0 Then kg_h8@=kg_r8@ Endif kg_b8@=1 kg_r8@=0
...
If bc9@=1 And kg_r9@>0 Then 
 If res_kg_on_off@=0 Then kg_h9@=kg_r9@ Endif kg_b9@=1 kg_r9@=0
...
If res_kg_on_off@=0 Then kg_h10@=kg_r10@ Endif kg_b10@=1 kg_r10@=0
...
If res_kg_on_off@=0 Then kg_h11@=kg_r11@ Endif kg_b11@=1 kg_r11@=0
...
If res_kg_on_off@=0 Then kg_h12@=kg_r12@ Endif kg_b12@=1 kg_r12@=0
